...
"""
poblar_EEG.py
Pobla la ontología OnTEPT con características extraídas de señales EEG.
...
def poblar_desde_EEG(ruta_onto: str,
                              ruta_datos: str,
                              ruta_salida: str):
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print(f"Uso: python poblar_EEG.py <ontologia.rdf> <datos.csv> <salida.rdf>")
        sys.exit(1)
